...
public class AuthService {
    ...
    public Jwt createJwt(User user) throws UserNotFoundException, UserAccountVerificationException {
        User userInDatabase = userRepository.findByUsername(user.getUsername()).orElseThrow(UserNotFoundException::new);
        if (userInDatabase.isEnabled()) {
            ...
            throw new UserAccountVerificationException();
    }
